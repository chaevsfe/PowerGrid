...
public class CircuitDesignTableEditMenu extends CircuitEditMenu<CircuitDesignTableBlockEntity> {
    public CircuitDesignTableEditMenu(int id, Inventory inv, CircuitDesignTableBlockEntity contentHolder) {
        super(ModdedMenus.CIRCUIT_DESIGN_TABLE_EDIT, id, inv, contentHolder);
    }
