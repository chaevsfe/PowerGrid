...
public class CircuitDesignTableLoadMenu extends AbstractCircuitDesignTableMenu<CircuitDesignTableBlockEntity> {
    public CircuitDesignTableLoadMenu(int id, Inventory inv, CircuitDesignTableBlockEntity contentHolder) {
        super(ModdedMenus.CIRCUIT_DESIGN_TABLE_LOAD, id, inv, contentHolder);
    }
