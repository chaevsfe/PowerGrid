...
public class ThermometerDisplaySourceRender extends SingleLineDisplaySourceRender {
    @Override
    public void initConfigurationWidgets(DisplaySource source, DisplayLinkContext context, ModularGuiLineBuilder builder, boolean isFirstLine) {
        ...
        builder.addSelectionScrollInput(0, 137, (si, l) -> si
                        .forOptions(Lang.translatedOptions("display_source.thermometer", "vs_absolute_max_bar", "vs_measured_max_bar", "vs_absolute_max", "vs_measured_max", "current", "measured_max"))
