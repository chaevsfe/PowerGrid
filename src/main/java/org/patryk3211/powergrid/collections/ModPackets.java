...
public class ModPackets {
    public static final PacketSet PACKETS = PacketSet.builder(PowerGrid.MOD_ID, 19) // increment version on changes
            ...
            .s2c(ElectroZapperS2CPacket.class, ElectroZapperS2CPacket::new)
            .s2c(ServerConfigS2CPacket.class, ServerConfigS2CPacket::new)
