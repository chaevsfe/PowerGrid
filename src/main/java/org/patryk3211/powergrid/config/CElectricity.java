...
public class CElectricity extends ConfigBase {
    ...
    public final ConfigFloat motorMinimumLoad = f(0.05f, 0, 1, "motorMinimumLoad", Comments.motorMinimumLoad);
    ...
    public final ConfigFloat acidBatteryFullChargeInternalResistance = f(0.1f, 0.001f, 100.0f, "acidBatteryFullChargeInternalResistance", Comments.acidBatteryFullChargeInternalResistance);
    ...
    public final ConfigInt groundingMaximumBlocks = i(64, 1, "groundingMaximumBlocks", Comments.groundingMaximumBlocks);
    ...
    private static class Comments {
        ...
        public static final String motorMinimumLoad = "Minimum load percentage for the dynamic motor resistance";
        ...
        public static final String acidBatteryCapacity = "Capacity of the acid battery, measured in watt-hours";
