...
public class CSolver extends ConfigBase {
    ...
    public final ConfigEnum<SolverBackend> solverBackend = e(SolverBackend.JAVA, "solverBackend", Comments.solverBackend);
    ...
    private static class Comments {
        ...
        public static final String solverBackend = "Solver MNA backend. This build ships only the portable Java backend.";
    }
}
