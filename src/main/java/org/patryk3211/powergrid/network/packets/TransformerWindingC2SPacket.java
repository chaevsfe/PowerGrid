...
public class TransformerWindingC2SPacket implements C2SPacket {
    ...
    public void handle(ServerPlayer player) {
        ...
        if (connection.isTransformer()) {
            // Alter existing tag
            stack.set(ModdedDataComponents.CONNECTION_DATA, connection.withTurns(nTurns));
        } else {
            // Create a new tag
            ...
            stack.set(ModdedDataComponents.CONNECTION_DATA, WireConnection.of(pos, nTurns, blockEndpoint));
        }
    }
}
