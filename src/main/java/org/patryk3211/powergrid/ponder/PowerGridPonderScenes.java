...
public class PowerGridPonderScenes {
    public static void register(PonderSceneRegistrationHelper<Identifier> helper) {
        ...
        helper.addStoryBoard(BuiltInRegistries.ITEM.getKey(AllItems.ELECTRON_TUBE), "circuit/electron_tube", CircuitScenes::electronTube, PowerGridPonderTags.CIRCUIT_COMPONENTS);
