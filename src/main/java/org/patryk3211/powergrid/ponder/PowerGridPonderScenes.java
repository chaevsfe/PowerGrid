...
import org.patryk3211.powergrid.registrate.entry.ItemProviderEntry;
...
public class PowerGridPonderScenes {
    public static void register(PonderSceneRegistrationHelper<Identifier> helper) {
        ...
        helper.addStoryBoard(BuiltInRegistries.BLOCK.getKey(AllBlocks.ENCASED_FAN), "encased_fan", DeviceScenes::encasedFan);
        ...
        helper.addStoryBoard(Identifier.withDefaultNamespace("lightning_rod"), "lightning_attractor", MagnetScenes::lightningAttractor);
        ...
        HELPER.addStoryBoard(ModdedItems.TRIODE, "circuit/triode", CircuitScenes::triode, PowerGridPonderTags.CIRCUIT_COMPONENTS);
        HELPER.addStoryBoard(ModdedItems.PENTODE, "circuit/pentode", CircuitScenes::pentode, PowerGridPonderTags.CIRCUIT_COMPONENTS);
        HELPER.addStoryBoard(ModdedItems.THYRATRON, "circuit/thyratron", CircuitScenes::thyratron, PowerGridPonderTags.CIRCUIT_COMPONENTS);
        ...
        helper.addStoryBoard(BuiltInRegistries.ITEM.getKey(Items.COPPER_NUGGET), "circuit/via", CircuitScenes::via, PowerGridPonderTags.CIRCUIT_COMPONENTS);
        ...
        helper.addStoryBoard(Identifier.fromNamespaceAndPath(Identifier.DEFAULT_NAMESPACE, "paper"), "circuit/label", CircuitScenes::label, PowerGridPonderTags.CIRCUIT_COMPONENTS);
    }
}
