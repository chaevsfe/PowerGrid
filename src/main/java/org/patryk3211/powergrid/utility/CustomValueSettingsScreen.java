...
public class CustomValueSettingsScreen extends ValueSettingsScreen {
    ...
    public static MutableComponent simpleFormat(ValueSettings settings) {
    ...
    private final Consumer<ValueSettings> saveCallback;

    public CustomValueSettingsScreen(BlockPos pos, ValueSettingsBoard board, ValueSettings valueSettings, Consumer<ValueSettings> saveCallback) {
